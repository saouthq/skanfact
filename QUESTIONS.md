...
- **14 — Du temps réservé à l'entretien.** Une équipe senior garde environ un cinquième de son
  ...
  9.1.0 en est une pour moitié** (l'outillage passe avant les livres), puis **9.4.10** après la
...
### 9.4.10 — Entretien (quelques jours)
...
- **Contenu.** Comme la 9.4.10 : Electron si une version est sortie, dette, découpage suivant
