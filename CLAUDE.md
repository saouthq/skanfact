...
**Fait depuis :** 3.0.0 a livré les achats/fournisseurs/dépenses et la v4. Reste 3.1.0 (TVA déductible et calendrier fiscal), 3.2.0 (trésorerie), 3.3.0 (marges), 3.4.0 (immobilisations), 4.x (stock, séries, photo de facture), 5.x (paie).
