...
(function (root, factory) {
  ...
  const INFO = {
    ...
    'cl.controles': { a: 'exercice', t: 'Les contrôles avant clôture', d: 'Six, et un septième quand le cabinet tient le registre des biens (le tableau d\'amortissement contre le compte 28). Ils <b>nomment, ils ne bloquent jamais</b> : un exercice clos avec trois manques signalés vaut mieux qu\'un exercice jamais clos parce que l\'application faisait la difficile. Chacun dit un <b>geste</b>, pas un constat — « valide-les », « ventile-la », « prépare-les ». Le dernier, l\'équilibre de la balance, est le seul qui soit vraiment grave : il veut dire qu\'une pièce est passée hors de la porte d\'écriture.' },
