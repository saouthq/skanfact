...
(function (root, factory) {
  ...
  const INFO = {
    ...
    'rp.balance': { a: 'tenue', t: 'La balance d\'ouverture', d: 'Ce que chaque compte portait <b>au premier jour</b> de l\'exercice : capital, banque, clients, fournisseurs, emprunts… Elle devient la pièce d\'à-nouveaux du livre. <b>Laisse-la vide pour un client qui démarre.</b> « Importer un CSV… » reprend celle d\'un autre logiciel (compte ; libellé ; débit ; crédit). Elle doit s\'équilibrer : débit = crédit.' },
    'd.from': { t: 'Début de mission', d: 'Le premier mois que tu attends de ce client, écrit comme <b>01/2026</b>. Laisse vide si tu veux partir du premier paquet reçu. Renseigne-le quand tu <b>reprends un dossier en cours d\'année</b> : sans cette date, les mois antérieurs ne te seraient jamais réclamés, et tu t\'en apercevrais au bilan.' },
