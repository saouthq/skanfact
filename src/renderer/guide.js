...
(function (root, factory) {
  ...
  const INFO = {
    ...
    // — éditeur de document —
    'ed.client': { t: 'Client', d: 'Choisis un client existant, ou clique sur <b>+</b> pour en créer un sans quitter le document. Son adresse, son matricule fiscal, sa langue, sa devise et son taux de retenue à la source sont repris automatiquement.' },
    'ed.date': { t: 'Date du document', d: 'La date qui s\'imprime et qui compte pour ta comptabilité : une facture datée du 31 janvier appartient à janvier, même émise le 2 février. C\'est aussi elle qui détermine l\'année du numéro (FAC-2026-001).' },
    'ed.due': { t: 'Échéance', d: 'La date limite de paiement, calculée à partir de ton délai par défaut. Passé ce jour et si la facture n\'est pas soldée, elle bascule automatiquement « en retard » et apparaît dans les Relances.' },
    'ed.validUntil': { t: 'Valable jusqu\'au', d: 'La date après laquelle ton prix n\'est plus garanti. Elle s\'imprime sur le devis. C\'est un argument utile : un client hésitant se décide plus vite quand une date est écrite.' },
    ...
    // — listes et pages —
    'list.filters': { t: 'Filtres', d: 'La recherche porte sur le numéro, le nom du client et l\'objet. Combine-la avec le statut pour retrouver, par exemple, toutes les factures en retard d\'un client.' },
