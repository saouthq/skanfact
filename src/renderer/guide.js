...
(function (root, factory) {
  ...
  const INFO = {
    ...
    'list.sort': { t: 'Trier la liste', d: 'Les titres de colonne marqués « ⇅ » se cliquent pour trier, une deuxième fois pour inverser. Une flèche pleine montre la colonne qui commande le tri. Le pied du tableau totalise toute la sélection, pas seulement la page affichée : combine avec les filtres pour obtenir, par exemple, le total facturé à un client sur une année.' },
