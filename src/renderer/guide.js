...
(function (root, factory) {
  ...
  const INFO = {
    ...
    'sup.due': { t: 'Reste à payer', d: 'Ce que tu dois encore à ce fournisseur, tous achats confondus, <b>net</b> de ce que tu détiens chez lui : un avoir pas encore déduit d\'une facture, ou une facture payée plus que son montant. C\'est le solde de son compte. Quand il est en ta faveur, la carte le dit : c\'est à toi de le récupérer — en déduction de sa prochaine facture, ou par un remboursement. La part en retard est signalée : c\'est elle qui abîme une relation commerciale.' },
    ...
    'ed.depositMode': { t: 'Pourcentage ou montant', d: 'Comment tu fixes l\'acompte : un pourcentage du devis, ou un montant TTC. Un montant est converti en pourcentage, et c\'est ce pourcentage que la facture de solde déduira. Sous les cases, tu vois ce que feront l\'acompte et le solde, timbre compris.', a: 'acompte' },
    ...
    'tre.moveAccount': { t: 'Compte', d: 'Le compte d\'où sort cet argent, ou sur lequel il arrive : c\'est son solde qui bouge. C\'est aussi son type (banque ou caisse) qui range l\'écriture au journal de banque ou de caisse.' },
