...
(function (root, factory) {
  ...
  const INFO = {
    ...
    'tre.moves': { t: 'Mouvements', d: 'Tout ce qui est entré et sorti de tes comptes cette année, quelle que soit l\'origine. Les encaissements viennent des factures, les règlements des achats : ils se modifient sur la pièce d\'origine (bouton ✎ à côté du paiement), y compris leur compte. Seuls les <b>mouvements libres</b> (salaires, impôts, apports, frais bancaires) se saisissent et se modifient ici.' },
