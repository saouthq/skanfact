...
(function (root, factory) {
  ...
  const INFO = {
    ...
    'upd.token': { t: 'Token GitHub', d: 'Un reste de l\'époque où le dépôt de SkanFact était privé : il fallait alors une clé d\'accès en lecture pour télécharger les mises à jour. Le dépôt est <b>public</b> depuis septembre 2026 et l\'application n\'a plus rien à présenter. Si un jeton est encore enregistré sur cet ordinateur, il ne sert plus à rien : le bouton le retire.' },
    'upd.beta': { t: 'Versions bêta', d: 'Deux canaux, une seule application. <b>Normal</b> (décoché) : tu reçois les versions terminées, celles que tout le monde installe. <b>Bêta</b> : tu reçois en plus les versions d\'essai, numérotées <code>7.26.0-beta.1</code>, qui servent à vérifier une nouveauté avant de la donner aux autres — elles peuvent contenir des défauts, c\'est leur raison d\'être.<br>Une bêta s\'installe par-dessus SkanFact et travaille sur les <b>mêmes données</b> : une sauvegarde « avant-beta » est prise au moment où tu coches. Décocher te ramène au canal normal ; si tu tournes sur une bêta, SkanFact la remplacera par la prochaine version stable. Sur l\'ordinateur qui tient la vraie comptabilité, laisse décoché.', a: 'partager' },
