...
(function (root, factory) {
  ...
  const INFO = {
    ...
    'data.external': { t: 'Copie externe', d: 'Le geste le plus important de ta gestion. Choisis un dossier dans iCloud Drive ou OneDrive, sur une clé USB ou un disque réseau : à chaque enregistrement, tes données, leurs sauvegardes et tes pièces jointes y sont recopiées, chaque entreprise dans son propre sous-dossier. Si ton ordinateur tombe en panne demain, ta comptabilité existe ailleurs, et « Importer » la reprend sur le nouveau.', a: 'donnees' },
    ...
    'cab.reponse': { a: 'cabinet', t: 'Ta réponse à ton comptable', d: 'Écris-la comme tu la dirais au téléphone : une phrase suffit (« relancé le 12, il paie fin du mois », « c\'est un acompte, la facture arrive »). Elle est gardée ici et part <b>toute seule dans ton prochain paquet</b> : il n\'y a rien d\'autre à envoyer. Tu peux la corriger : c\'est la dernière version qui part. <b>Rien de tes chiffres ne change</b> : une réponse explique, elle n\'écrit pas. Si ton comptable attend une pièce, joins-la sur la facture ou l\'achat lui-même — elle part déjà dans le paquet.' },
...
<p>Sur l'accueil, le bouton <b>Voir un exemple rempli</b> charge cinq ans d'activité fictive, et « Visite guidée » t'en fait faire le tour. Clique partout, casse tout, ça n'a aucune importance : <b>tes données sont mises de côté avant</b>, et un bandeau lilas reste affiché sur chaque page tant que l'exemple est chargé — avec « Quitter l'exemple » pour retrouver tes données.</p>
<p>Pour en sortir, ce même bandeau porte <b>Quitter l'exemple</b> : il te rend exactement ce que tu avais. N'utilise pas « Tout effacer » pour ça — ce bouton-là efface pour de bon, il ne restaure rien.</p>
