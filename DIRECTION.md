...
| 1 | **9.1.0** — les livres lus dans les paquets (livre-journal, grand livre, balance, lettrage) ; `compta.js` extrait ; test de parité ; côté entreprise, le module Comptabilité masqué par défaut et l'option `compta` dans la clé | rien |
