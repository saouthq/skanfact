...
| 3 bis | **9.4.3** — entretien, sans nouveauté (Electron, les 93 déclarations CSS en logiques, premier découpage d'`app.js`, dette) ; puis **9.6.1** et **9.9.1** aux mêmes conditions — la règle « une version sur quatre » est numérotée dans `QUESTIONS.md` § 16, pas promise | rien |
